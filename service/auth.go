...
func NewAuthService(repo repository.Authorization, accessTokenTTL, refreshTokenTTL time.Duration) *AuthService {
	return &AuthService{repo: repo, accessTokenTTL: accessTokenTTL, refreshTokenTTL: refreshTokenTTL}
}
